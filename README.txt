This project contains two components, a Calculator Client and Log Server.  The Calculator is a simple calculator that can perform addition, subtraction, multiplication, and division on whole numbers.  The Log Server ouptuts all successfully-executed expressions and calculations.
